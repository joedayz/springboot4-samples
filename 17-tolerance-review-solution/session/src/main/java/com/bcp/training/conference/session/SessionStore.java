...
public class SessionStore {
    ...
    /** Used by findByIdWithoutEnrichmentMaybeFail for retry lab (fails 4 of 5 calls). */
    ...
    /**
     * For retry lab: fails with 500 until counter % 5 == 0 (succeeds every 5th call).
     * Call from session controller so that @Retry can retry until success.
     */
    @Transactional(readOnly = true)
